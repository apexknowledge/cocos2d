 ...
 * <p/>
 * All features from CocosNode are valid, plus the following features: - opacity - color (setRGB:::)
 * - contentSize
 */
 ...
 * protocol
 * 
 * It knows how to render a TextureAtlas object. If you are going to render a TextureAtlas consider
 * subclassing CCAtlasNode (or a subclass of CCAtlasNode)
 * 
...
public abstract class CCAtlasNode extends CCNode implements CCRGBAProtocol, CCTextureProtocol {
    ...
    /**
     * initializes an CCAtlasNode with an Atlas file the width and height of each item and the
    ...
    public void draw(GL10 gl) {
        ...
        // XXX: There is no need to restore the color to (255,255,255,255). Objects should use the
        // color
        // XXX: that they need
